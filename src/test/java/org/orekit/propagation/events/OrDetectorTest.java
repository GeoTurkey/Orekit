...
public class OrDetectorTest {
    ...
    public void testInit() {
        ...
        Mockito.when(a.getMaxCheckInterval()).thenReturn((state, forward) ->AbstractDetector.DEFAULT_MAXCHECK);
        ...
        Mockito.when(b.getMaxCheckInterval()).thenReturn((state, forward) ->AbstractDetector.DEFAULT_MAXCHECK);
    ...
    private static class MockDetector implements EventDetector {
        ...
        public AdaptableInterval getMaxCheckInterval() {
            return (state, forward) -> AbstractDetector.DEFAULT_MAXCHECK;
        }
