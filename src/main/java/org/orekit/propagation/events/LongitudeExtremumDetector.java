...
public class LongitudeExtremumDetector extends AbstractDetector<LongitudeExtremumDetector> {
    ...
    public LongitudeExtremumDetector(final double maxCheck, final double threshold,
        ...
        this((state, forward) -> maxCheck, threshold, DEFAULT_MAX_ITER, new StopOnIncreasing(),
             body);
    }
    ...
    /** {@inheritDoc} */
    @Override
    protected LongitudeExtremumDetector create(final AdaptableInterval newMaxCheck, final double newThreshold,
