...
public class Skat {
    ...
    public Skat(final File input)
        ...
        maneuversOutput.println("# column 17: flag indicating whether the manoeuvre is performed during eclipse");
        maneuversOutput.println("# column 18: yaw angle (deg)");
        maneuversOutput.println("# column 19: replanned flag (if not replanned, empty column)");
        maneuversOutput.println("#");
