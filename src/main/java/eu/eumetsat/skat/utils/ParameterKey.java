...
public enum ParameterKey {
    ...
    CONTROL_YAW_FLIP_SEQUENCE("yaw_flip_sequence"),
    ...
    COMPONENT_CROSS_COUPLING_STANDARD_DEVIATION1("standard_deviation"),
    COMPONENT_CROSS_COUPLING_DIRECTION_1("coupling_direction"),
    COMPONENT_CROSS_COUPLING_CONSTANT_RATIO_1("coupling_ratio"),
    COMPONENT_CROSS_COUPLING_SECULAR_VARIATION_1("coupling_ratio_secular_variation"),
    COMPONENT_CROSS_COUPLING_SECULAR_ZERO_1("coupling_ratio_secular_zero"),
    COMPONENT_CROSS_COUPLING_PERIOD_1("coupling_ratio_period"),
    COMPONENT_CROSS_COUPLING_PERIOD_ZERO_1("coupling_ratio_period_zero"),
    COMPONENT_CROSS_COUPLING_AMPLITUDE_1("coupling_ratio_amplitude"),
    COMPONENT_CROSS_COUPLING_STANDARD_DEVIATION2("standard_deviation_2"),
    COMPONENT_CROSS_COUPLING_DIRECTION_2("coupling_direction_2"),
    COMPONENT_CROSS_COUPLING_CONSTANT_RATIO_2("coupling_ratio_2"),
    COMPONENT_CROSS_COUPLING_SECULAR_VARIATION_2("coupling_ratio_secular_variation_2"),
    COMPONENT_CROSS_COUPLING_SECULAR_ZERO_2("coupling_ratio_secular_zero_2"),
    COMPONENT_CROSS_COUPLING_PERIOD_2("coupling_ratio_period_2"),
    COMPONENT_CROSS_COUPLING_PERIOD_ZERO_2("coupling_ratio_period_zero_2"),
    COMPONENT_CROSS_COUPLING_AMPLITUDE_2("coupling_ratio_amplitude_2"),
    ...
    COMPONENT_MANEUVER_ECLIPSE_CONSTRAINT_LONG_BURN_COMPENSATION("long_burn_compensation"),
